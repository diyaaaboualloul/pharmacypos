    ...
    <>
            ...
            if (item.subItems) {
              ...
              return (
                <li key={item.label} className="nav-item my-1">
                  ...
                  <ul
                    id={`sec-${item.label}`}
                    className={`sublist list-unstyled ps-4 ${isSectionOpen ? "d-block" : "d-none"}`}
                  >
      ...
      >
        <div className="offcanvas-header border-bottom border-secondary">
          <h5 id="sidebarMenuLabel" className="offcanvas-title">📋 Menu</h5>
          <button
            type="button"
              ...
              if (item.subItems) {
                ...
                return (
                  <li key={item.label} className="nav-item my-1">
                    ...
                    <ul
                      id={`m-sec-${item.label}`}
                      className={`sublist list-unstyled ps-4 ${isOpen ? "d-block" : "d-none"}`}
                    >
                      {item.subItems.map((sub) => (
                        <li key={sub.to}>
                          <NavLink
